...
Sérgio decidiu embarcar em um projeto pessoal de desenvolver uma **API REST** utilizando a linguagem de programação **Crystal**. Seu objetivo é adquirir novos conhecimentos e aprimorar suas habilidades.
