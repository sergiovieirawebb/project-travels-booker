...
Sérgio decidiu embarcar em um desafio pessoal de desenvolver uma **API REST** utilizando a linguagem de programação **Crystal**, a qual ele não está familiarizado. Seu objetivo é adquirir novos conhecimentos e aprimorar suas habilidades.
